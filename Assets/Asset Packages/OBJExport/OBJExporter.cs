...
//Added Scene management - Richie(RalphVR)
...
public class OBJExporter : ScriptableWizard
{
    ...
    void Export(string exportPath)
    {
        ...
        sb.AppendLine("# Export of " + SceneManager.GetActiveScene().name); //Chenged to use scene manager - Richie(RalphVR)
    ...
    string ExportTexture(Texture2D t)
    {
        ...
        catch (System.Exception ex)
        {
            ...
            Debug.Log(ex.Message); //Added outputting exception message, mostly to gid rid of warning in editor - Richie(RalphVR)
            return "null";
        }
